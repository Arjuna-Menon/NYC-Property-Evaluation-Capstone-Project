...
data = data.drop(['sanitboro', 'unitstotal', 'cd',
                  'healthcenterdistrict', 'ycoord', 'xcoord',
                  'bldgarea', 'zonedist1'], axis =1)


#Scpecify what columns are factors
to_factors = ["schooldist","council","zipcode","policeprct","firecomp",
               "healtharea","sanitsub","spdist1","ltdheight","landuse",
               "ext","proxcode","irrlotcode","lottype","borocode","edesignum","sanitdistrict", "pfirm15_flag"]
...
#Check min error
min(error_test) # 34229.01 for test and 18250.55 for train - 14 predictors
